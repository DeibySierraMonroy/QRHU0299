...
SELECT    PD.TPD_CODIGO CODIGO_DOCUMENTO
         ,TD2.TPD_DESCRIPCION NOMBRE_DOCUMENTO
         ,LD.RADO_ESTADO ESTADO_DOCUMENTO
         ,LD.RADO_REQUERIDO REQUERIDO
         ,LD.RADO_OBSERVACIONES OBSERVACION
         ,AZD.AZD_CODIGO_CLI AZCODIGO
...
SELECT INC.EPL_ND NUMERO_DOCUMENTO, 
               ...
               (SELECT EMP_ND from contrato where CTO_NUMERO = INC.CTO_NUMERO ) PRINCIPAL
...
SELECT DISTINCT(INC.INC_RADICACION),
INC.*,
TINC.TIPOINC_NOMBRE,SINC.SUBTIPOINC_NOMBRE,
RHU.FB_EMPLEADO_COLUMNA(INC.TDC_TD_EPL,INC.EPL_ND,'NOMBRE') NOMBRE_COMPLETO
,(SELECT FB_NOM_EMPRESA(TDC_TD_FIL, EMP_ND_FIL)  FROM CONTRATO WHERE CTO_NUMERO = INC.CTO_NUMERO) NOMBRE_EMPRESA_USUARIA
FROM 
RHU.RADICACION_DOCUMENTOS RAD , INCAPACIDAD INC ,
RHU.TIPO_INCAPACIDAD TINC,  RHU.SUBTIPO_INCAPACIDAD SINC
WHERE RAD.INC_RADICACION = INC.INC_RADICACION
...
REP.PB_ENVIA_X_E_DELIVERY('notificacion@activos.com.co', -- ORIGEN
