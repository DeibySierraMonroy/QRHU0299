...
--*************************************************************************
ALTER TABLE RHU.DOCUMENTO_INC_SUBTIPO ADD CONSTRAINT DOCINCSUB_ESTADO_C CHECK (DOCINCSUB_ESTADO IN ('ACTIVO' , 'DESACTIVADO'));
...
--*************************************************************************
GRANT SELECT ON RHU.DOCUMENTO_INC_SUBTIPO TO PUBLIC;
CREATE PUBLIC SYNONYM DOCUMENTO_INC_SUBTIPO FOR RHU.DOCUMENTO_INC_SUBTIPO;
GRANT ALL ON RHU.DOCUMENTO_INC_SUBTIPO TO PUBLIC;

--*************************************************************************
--** CREACION DE SECUENCIA.
--*************************************************************************
CREATE SEQUENCE RHU.SEQDOCUMENTO_INC_SUBTIPO INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 NOCACHE;
GRANT ALL ON RHU.SEQDOCUMENTO_INC_SUBTIPO TO PUBLIC;
